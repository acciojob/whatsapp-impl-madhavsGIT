...
public class WhatsappController {
    ...
    public String createGroup(@RequestBody List<User> users){
    ...
    public int sendMessage(@RequestParam("message") Message message,
                          ...
                          @RequestParam("group") Group group) throws Exception{
    ...
    public String changeAdmin(@RequestParam("approver") User approver,
    ...
    public int removeUser(@RequestParam("user") User user) throws Exception{
